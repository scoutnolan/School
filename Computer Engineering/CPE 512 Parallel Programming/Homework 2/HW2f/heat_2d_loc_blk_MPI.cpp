    ...
    for (int i=0;i<num_iterations;i++) {
        if (rank%2==0) { // even numbered processes
            if(up_flag){
                ...
                MPI_Sendrecv(&temp[active_rows_on_proc*total_cols],total_cols,
                            MPI_DOUBLE, up_pr, 123,
                            &temp[(active_rows_on_proc+1)*total_cols],
            ...
            if (rank>0) {
                if(down_flag){
                    ...
                    MPI_Sendrecv(&temp[total_cols],total_cols,
                                MPI_DOUBLE, down_pr, 123,
                                &temp[0], total_cols, MPI_DOUBLE, 
