...
// ********************************* //
    ...
    class gamewindow : public QMainWindow
    {
        ...
        public:
            ...
            Stick::Player* PlayerData = new Player();

            QGraphicsEllipseItem* attackCircle;
            QGraphicsEllipseItem* target;
            QGraphicsPolygonItem* targetObject;
            QGraphicsRectItem* player;
            QLabel *attackL;

            int randomx, randomy, playerCount;
            int playerscore = 0;
