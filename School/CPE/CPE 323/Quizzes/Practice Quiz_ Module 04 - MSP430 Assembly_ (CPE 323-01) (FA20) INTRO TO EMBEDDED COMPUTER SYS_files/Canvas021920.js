...
var BLUE_CANVAS_SETUP={connectorUrl:"https://uah.bluera.com/uahBlueConnector/",canvasAPI:"https://uah.instructure.com",domainName:"com.explorance",consumerID:"4ka4tx4nLdejNUrQDGL9zA==",defaultLanguage:"en-us"},BlueCanvasJS=document.createElement("script");BlueCanvasJS.setAttribute("type","text/javascript");BlueCanvasJS.setAttribute("src","https://uah.bluera.com/uahBlueConnector//Scripts/Canvas/BlueCanvas.min.js?"+(new Date).getTime());document.getElementsByTagName("head")[0].appendChild(BlueCanvasJS);
...
function addMenuItem(linkText, linkhref, icon, target) {  
  ...
  '  <a id="global_nav_' + linkId + '" href="' + linkhref + '" rel="noopener" class="ic-app-header__menu-list-link" ' + newTab + '>' +  
...
addMenuItem('Resources', 'https://uah.instructure.com/courses/41042', 'icon-pin', '_blank');
...
googleAnalyticsCode("UA-129363977-1") // google analytics tracking id 