// ****************************
// Project Title: Investment Program
// Project File: Project_03.cpp
// Name: Nolan Anderson
// Course Section CPE-211-01
// Lab Section: 2
// Due Date: 9/04/2019
// program description: Finds the value of an investment over time
...
double eff_continue_balance;
	...
	cout << "\tBalance = $" << a_simple << endl; // Outputs the balance found above and ends the line  
	cout << "\n" << endl;
	...
	eff_daily  = (a_daily - P)/1000.0;	// Finds the effective interest rate
	...
	eff_continue = (a_continue - P)/1000.0;  // Finds the effective interest rate
