...
fprintf('The average for exam two is a %.2f.\n', avgex2)
...
%% Who did better than the average on both / either exam
...
b = students(a) % If a student was found to be true in 'a', this assigns that students number with the true value.
...
d = students(c) % If a student was found to be true in 'c', this assigns that students number with the true value.
